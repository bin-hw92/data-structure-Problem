# 프로그래머스 과제물 - 고양이 사진첩입니다.

해당 문제를 2가지 방벅으로 연습했으며, 현재 기본은 클래스 객체로 만든부분이며,

src/componets_function에 등록된 JS는 함수형 객체로 만든 부분입니다.

처음부터 끝까지 만들어야 하는 과제로 JS를 처음부터 다시 점검하기에 좋은 문제 입니다.

-> 처음에는 function으로 만들어보고, 모르는 부분들은 다른 분들 내용을 참고했으며, 그 뒤 20년 상반기 과제는 Class로 만들어져 있는 것을 보고
Class 로 변경도 해봤습니다. 다른 분들도 참고해서 한번 진행해보면 좋을 것 같습니다.


출처: 프로그래머스 코딩 테스트 연습 과제물 '2021 Dev-Matching: 웹 프론트엔드 개발자(상반기)', https://programmers.co.kr/skill_check_assignments/100
...
### root 경로 탐색 중인 경우
![img1](https://user-images.githubusercontent.com/45866008/157001658-19828589-e578-4a2d-ad95-7444decfb067.png)
...
![img2](https://user-images.githubusercontent.com/45866008/157001723-dcd7a694-c7b0-402a-9093-3d5115868280.png)

- 맨 왼쪽 화살표를 누른 경우, 이전 디렉토리로 돌아갑니다.
- 파일을 누른 경우 해당 파일의 filePath 값을 이용해 이미지를 보여줍니다.

### 물 마시는 사진(파일)을 클릭한 경우
![img3](https://user-images.githubusercontent.com/45866008/157001728-c7ff5c5e-4bfc-4fa0-beb8-6d83138a58a9.png)
